...
int main(void)
{
    ...
    /****************************************************************************************************/
    InitUnsupervisedKMeansModif(10, 0.9);
                    ...
                    if(!TrainingFinished){
                        ...
                        if(TrainingResult == 1){
                            ...
                            for(clusterIndex = 0; clusterIndex<NumberOfClusters; clusterIndex++){
                                ...
                                unsigned char payload[3 + clusterDimension*3];
                                ...
                                for(dimensionIndex = 0; dimensionIndex < clusterDimension; dimensionIndex++){
                                    payload[3 + dimensionIndex*3] = (uint8) ((uint16)Clusters[clusterIndex][dimensionIndex]>>8);
                                    payload[4 + dimensionIndex*3] = (uint8) ((uint16)Clusters[clusterIndex][dimensionIndex]);
                                    payload[5 + dimensionIndex*3] = (uint8) ((Clusters[clusterIndex][dimensionIndex] - (uint16)Clusters[clusterIndex][dimensionIndex])*100);
                                }
                                MakeAndSendMessageWithUTLNProtocol(0x0029, 3 + clusterDimension*3, payload);
                            }
                        }
